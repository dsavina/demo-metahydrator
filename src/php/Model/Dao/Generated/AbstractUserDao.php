...
class AbstractUserDao
{
     ...
     *
     * @return User[]|ResultIterator|ResultArray
     */
     ...
     */
    public function getById(int $id, $lazyLoading = false) : User
    {
     ...
     * @return User|null
     */
    protected function findOneFromSql($from, $filter = null, array $parameters = []) : ?User
    {
